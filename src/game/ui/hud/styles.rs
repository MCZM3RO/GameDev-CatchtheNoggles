...
pub const LHS_STYLE: Style = Style {
    ...
    align_items: AlignItems::Center,
    size: Size::new(Val::Px(200.0), Val::Percent(60.0)),
    margin: UiRect::new(Val::Px(36.0), Val::Px(0.0), Val::Px(0.0), Val::Px(0.0)),
    ..Style::DEFAULT
};
...
pub const IMAGE_STYLE: Style = Style {
    ...
    margin: UiRect::new(Val::Px(8.0), Val::Px(8.0), Val::Px(15.0), Val::Px(0.0)),
    ..Style::DEFAULT
};
